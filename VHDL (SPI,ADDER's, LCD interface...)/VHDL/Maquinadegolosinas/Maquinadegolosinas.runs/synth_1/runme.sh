...
HD_PWD='C:/Carlos Perez Araujo/Proyectos Personales/Vhdl/Xilinx/Maquinadegolosinas/Maquinadegolosinas.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LCD.vds -m64 -mode batch -messageDb vivado.pb -notrace -source LCD.tcl
